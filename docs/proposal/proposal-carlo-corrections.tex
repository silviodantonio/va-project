...
Section B presentes the result of a PCA performed on the dataset.
...
Furthermore, the user can visually trigger an analytic directly from the PCA by requesting the system
to find clusters (\textit{e.g. k-means}) within a selected subset of data points.
